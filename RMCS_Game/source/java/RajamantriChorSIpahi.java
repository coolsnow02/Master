public class RajamantriChorSIpahiChorSIpahi extends Activity {
	...
	Button btnRajamantriChorSIpahiChorSIpahi;
	Button btnHelp;
	ImageView btn9;
	Button btnPlay;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnRajamantriChorSIpahi = (Button) findViewById(R.id.btnRajamantriChorSIpahi);
        btnRajamantriChorSIpahi.setOnClickListener(new OnClickListener() {
				...
				btnPlay.setOnClickListener(new OnClickListener() {
		 			...
		 			public void onClick(View v) {
		 				...
		 				if(btnPlay.getText().equals("SHUFFLE")){
		 					...
		 					Log.v("RajamantriChorSIpahi", "########## Player Name:" + player1_name +" Role:" + player1_role);
		 					Log.v("RajamantriChorSIpahi", "########## Player Name:" + player2_name +" Role:" + player2_role);
		 					Log.v("RajamantriChorSIpahi", "########## Player Name:" + player3_name +" Role:" + player3_role);
		 					Log.v("RajamantriChorSIpahi", "########## Player Name:" + player4_name +" Role:" + player4_role);
						}
